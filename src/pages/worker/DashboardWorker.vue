<template>
  <div
    ...
    <header
      ...
      <div class="flex items-center gap-3 justify-between p-4">
        ...
        <div>
          ...
          <!-- today -->
          <div class="text-sm text-gray-500 dark:text-gray-400">{{ todayTxt }}</div>
        </div>
        <Weather />
        <DarkMode />
      </div>
    ...
    <!-- main -->
    <main
      class="overflow-y-auto overflow-x-hidden w-full max-h-[calc(100vh-68px)] pt-32 dark:bg-gray-700">
...
const todayTxt = new Date().toLocaleDateString("ko-KR", {
  weekday: "long",
  year: "numeric",
  month: "long",
  day: "numeric",
